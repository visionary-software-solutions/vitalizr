...
class VitalSerializationStrategy {
    static Collection<Vital> deserialize(final File data) {
        try {
    ...
    static void serialize(final Collection<Vital> toWrite, final File data) {
        toWrite.forEach(v -> {
